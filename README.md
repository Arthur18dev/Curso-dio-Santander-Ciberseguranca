...
2 - Comando para abrir uma lista de arquivos:
...
4 - Outro comando para as senhas:
<br>
...
5- Esse comando serve para simular dois usuário gerando senhas e uusário:
<br>
...
6 - Outro comando para saber se ele vai ter acesso ao administrador:
<br>
